...
checkbox_promocoes = tk.Checkbutton(janela, text="Deseja receber emails promocionais?", variable=var_promocoes)
checkbox_promocoes.grid(row=0, column=0)

var_politicas = tk.IntVar()
checkbox_poiticas = tk.Checkbutton(text="Aceitar termos de Uso e Políticas de Privacidade?", variable=var_politicas) 
checkbox_poiticas.grid(row=1, column=0)
...
botao_enviar = tk.Button(text="Enviar", command=def_enviar)
